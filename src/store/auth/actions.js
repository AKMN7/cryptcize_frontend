...
export default {
	...
	async signIn(context, payload) {
		// API EndPoint
		const endPoint = "https://cooperative-deer-overalls.cyclic.app/api/v1/users/signin";
	...
	async signUp(context, payload) {
		// API EndPoint
		const endPoint = "https://cooperative-deer-overalls.cyclic.app/api/v1/users/signup";
	...
	async updatePersonal(context, payload) {
		...
		const endPoint = "https://cooperative-deer-overalls.cyclic.app/api/v1/users/updatePersonal";
		...
		const response = await axios
			.patch(endPoint, data, { headers: { Authorization: `Bearer ${token}` } })
	...
	async updateSecurity(context, payload) {
		...
		// API Endpoint To update user's personal details
		const endPoint = "https://cooperative-deer-overalls.cyclic.app/api/v1/users/updatePassword";
	...
	async forgotPassword(_, payload) {
		// API Endpoint To update user's personal details
		const endPoint = "https://cooperative-deer-overalls.cyclic.app/api/v1/users/forgotPassword";
	...
	async resetPassword(_, payload) {
		...
		const endPoint = `https://cooperative-deer-overalls.cyclic.app/api/v1/users/resetPassword/${payload.resetToken}`;
