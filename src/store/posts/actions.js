...
export default {
    ...
    async addPost(context, payload) {
        ...
        const endPoint = "https://cryptcize.herokuapp.com/api/v1/posts/addPost";
        ...
        await axios.post(endPoint, data,
            { headers: { "Authorization": `Bearer ${token}` } }).catch(function (error) {
    ...
    async getCoinPosts(context, payload) {
        ...
        // API Endpoint to add a post
        const endPoint = `https://cryptcize.herokuapp.com/api/v1/posts/coinPosts/${payload}`;
    ...
    async getAllCoinPosts(context) {
        ...
        // API Endpoint to add a post
        const endPoint = `https://cryptcize.herokuapp.com/api/v1/posts/`;
    ...
    async getAllUserPosts(context) {
        ...
        // API Endpoint to add a post
        const endPoint = `https://cryptcize.herokuapp.com/api/v1/posts/userPosts`;
    ...
    async getTop7Likes(context) {
        ...
        // API Endpoint to add a post
        const endPoint = `https://cryptcize.herokuapp.com/api/v1/main/getTopFavs`;
    ...
    async getTopTopics(context) {
        ...
        // API Endpoint to add a post
        const endPoint = `https://cryptcize.herokuapp.com/api/v1/topics/getTopTopics`;
    ...
    async createTopic(context, payload) {
        ...
        // API Endpoint to add a post
        const endPoint = "https://cryptcize.herokuapp.com/api/v1/topics/createTopic";
    ...
    async getTopicInfo(context, payload) {
        ...
        const topicInfoEndPoint = `https://cryptcize.herokuapp.com/api/v1/topics/searchTopic`;
        ...
        // Get the topic Info
        const topicInfoResponse = await axios.post(topicInfoEndPoint, data,
    ...
    async getTopicComments(context, payload) {
        ...
        const topicCommentsEndPoint = `https://cryptcize.herokuapp.com/api/v1/topics/getComments/${payload}`;

        // Get the topic Comments
        const topicCommentsResponse = await axios.get(topicCommentsEndPoint,
            { headers: { "Authorization": `Bearer ${token}` } }).catch((error) => {
                console.log('*** ERROR 1 ***', error);
                throw new Error("Something went wrong while fetching data, Please try again later.");
            });
    ...
    async addComment(context, payload) {
        ...
        // API Endpoint to add a post
        const endPoint = `https://cryptcize.herokuapp.com/api/v1/topics/addComment/${payload.topicID}`;

        // Send HTTP Request
        await axios.post(endPoint, { text: payload.text },
            { headers: { "Authorization": `Bearer ${token}` } }).catch(function (error) {
                throw new Error(error.response.data.msg);
            });
    },
